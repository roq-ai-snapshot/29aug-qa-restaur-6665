...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`29Aug-Qa-Restaurant booking engine`}</title>

        <meta
          name="description"
          content="Welcome to 29Aug-Qa-Restaurant booking engine, revolutionizing restaurant management with seamless table reservations and efficient menu management for a superior dining experience."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`29Aug-Qa-Restaurant booking engine`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to 29Aug-Qa-Restaurant booking engine, revolutionizing restaurant management with seamless table reservations and efficient menu management for a superior dining experience.`}
            </Text>
            <Box
